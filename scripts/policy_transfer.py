...
# IMPORTANT: Import diffused_fields BEFORE stable_baselines3 to avoid Open3D/MuJoCo conflicts
from diffused_fields.core import Config
...
# RL model path
model_path = Config.get_policy_dir() / "ppo_pointmass_circle_local.zip"
